		...
		// TODO Auto-generated method stub
	      ...
	      // }
			...
			String sql_user_follows_user = "CREATE TABLE user_follows (\n" +
					"    user_ varchar(20),\n" +
					"    user_follows varchar(20),\n" +
					"    PRIMARY KEY (user_, user_follows),\n" +
					"    constraint fk_follow_user foreign key (user_) references user(username),\n" +
					"    constraint fk_follow_user_follows foreign key (user_follows) references user(username)\n" +
					");";
			...
			try {
				...
				String [] queries = {
						...
						"insert into user (first_name, last_name, username, password, email) values ('Hass', 'Mouz', 'Mouz', 'password', 'mouz@wsu.com')",
						...
						"insert into user_has_hobby (username, hobby) values ('Hass', 5)",
						...
						"insert into user_follows (user_, user_follows) values ('McFads1', 'Obeidah')",
						"insert into user_follows (user_, user_follows) values ('BTA', 'Shair')",
						"insert into user_follows (user_, user_follows) values ('Obeidah', 'Ack')",
						"insert into user_follows (user_, user_follows) values ('Shair', 'BTA')",
						"insert into user_follows (user_, user_follows) values ('Hass', 'Moneer')",
						"insert into user_follows (user_, user_follows) values ('Ack', 'Fadi')",
						"insert into user_follows (user_, user_follows) values ('Moneer', 'Amira')",
						"insert into user_follows (user_, user_follows) values ('Hannan', 'Fadi')",
						"insert into user_follows (user_, user_follows) values ('Amira', 'Moneer')",
						"insert into user_follows (user_, user_follows) values ('Bas', 'Moe')",
						"insert into user_follows (user_, user_follows) values ('Moe', 'Bas')",

						//fill the blog tables
						"insert into blog (subject, description) values ('launch!', 'hello world!')",
						"insert into blog (subject, description) values ('workout!', 'benched two plates today!')",
						"insert into blog (subject, description) values ('star wars!', 'just finished watching star wars, was great!')",
						"insert into blog (subject, description) values ('work!', 'work is such a bummer, need to quit')",
						"insert into blog (subject, description) values ('sleepy!', 'I dont get enough of it!')",
						"insert into blog (subject, description) values ('anime!', 'attack on titan is best anime!')",
						"insert into blog (subject, description) values ('squats!', 'squats are by far the hardest workout')",
						"insert into blog (subject, description) values ('music!', 'taylor swift is my favorite artist')",
						"insert into blog (subject, description) values ('video games!', 'dark souls is my favorite game')",
						"insert into blog (subject, description) values ('sleep!', 'I dont get enough sleep. maybe 4 hours a night')",
						"insert into blog (subject, description) values ('crypto!', 'I lost so much money because of crypto currency')",
						...
						"insert into user_blog (username, blog_id) values ('Hass', 5)",
						...
						"insert into user_blog (username, blog_id) values ('Bas', 10)",
						...
						"insert into tags (description) values ('must'-see)",
						...
						"insert into comment_to_blog (username, blog_id, comment_id) values ('Hass', 6, 6)",
				...
				fillDbStatement = connection.createStatement();
